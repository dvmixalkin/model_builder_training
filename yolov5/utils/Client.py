...
class ws_client:
    ...
    def socket_handler(self):
        ...
        self.ws = websocket.WebSocketApp(f"ws://{self.server_address}:{self.server_port}", on_open=self.ws_open, on_message= self.on_message_callback, on_close=self.ws_close)
        self.ws.run_forever()
